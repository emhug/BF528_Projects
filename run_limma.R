# Written by Emily Hughes, April 9 2020
# This code was written as part of the Boston University Bioinformatics Masters Program
# BF528: Applications in Translational Bioinformatics, Project 3

# This code was written to run limma on microarray results on group 6 chemicals: 3-methylcholanthrene, fluconazole, and pirinixic acid
